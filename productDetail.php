...
?>
                ...
                <div class="shop-details-wrapper">
                    <div class="row">
                            ...
                            <div class="tab-content">
                                <div id="thumb1" class="tab-pane fade show active">
                                    <div class="shop-thumb">
                                        <img src="assets/img/inner/shop/shop-details-01.jpg" alt="img">
                                    </div>
                                </div>
                                ...
                                <ul class="nav mb-5">
                                    <li class="nav-item">
                                        <a href="#thumb1" data-bs-toggle="tab" class="nav-link ps-0 active">
                                            <img src="assets/img/inner/shop/shop-details-02.jpg" alt="img">
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#thumb2" data-bs-toggle="tab" class="nav-link">
                                            <img src="assets/img/inner/shop/shop-details-03.jpg" alt="img">
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#thumb3" data-bs-toggle="tab" class="nav-link">
                                            <img src="assets/img/inner/shop/shop-details-04.jpg" alt="img">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-7">
                            ...
                            <h6 class="details-info"><span>SKU:</span> <a href="productDetail.php">124224</a></h6>
                            <h6 class="details-info"><span>Categories:</span> <a href="productDetail.php">Crux Indoor Fast and Easy</a></h6>
                            <h6 class="details-info"><span>Tags:</span> <a href="productDetail.php">accessories, business</a></h6>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="review-items">
                                <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                    <div class="admin-img pb-4 pb-md-0 me-4">
                                        <img src="assets/img/inner/shop/client-01.jpg" alt="image">
                                    </div>
                                ...
                                <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                    <div class="admin-img pb-4 pb-md-0 me-4">
                                        <img src="assets/img/inner/shop/client-02.jpg" alt="image">
                                    </div>
                                    <div class="content p-4">
                                        <div class="head-content pb-1 d-flex flex-wrap justify-content-between">
                                ...
                                <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                                    <div class="admin-img pb-4 pb-md-0 me-4">
                                        <img src="assets/img/inner/shop/client-03.png" alt="image">
                                    </div>
                                    <div class="content p-4">
                                        <div class="head-content pb-1 d-flex flex-wrap justify-content-between">
        ...
        <!-- shop Section Start -->
        <section class="shop-cart-section section-padding fix pt-0">
            <div class="container">
